...
\begin{table}
	\begin{center}
		\begin{tabular}{c|l|c|c|c|}
			...
			\hline
			\multicolumn{1}{|c|}{2} & Parking lot square II & $640 \times 360$ & 107,946 & 271\\
			\hline
			\multicolumn{1}{|c|}{3} & Crossroad I & $640 \times 360$ & 85,766 & 291\\
			\hline
			\multicolumn{1}{|c|}{4} & Crossroad II & $640 \times 360$ & 106,459 & 937\\
			\hline
			\multicolumn{1}{|c|}{5} & Library lobby I & $1280 \times 720$ & 49,679 & 316\\
			\hline
			\multicolumn{1}{|c|}{6} & Subway station plaza I & $640 \times 360$ & 107,876 & 1038\\
			\hline
		\end{tabular}
	\end{center}
...
There are three necessary parameters for the proposed tube rearrangement algorithm: the weight parameter of the length energy $\lambda$, the size of the occupation matrix $\mathcal{M}\times\mathcal{N}$, and the size of the queue $K$. Apart from six test sequences used for the performance evaluation, additional five video clips are prepared to find optimum parameters and detail characteristics of the videos are summarized in Table~\ref{tb:video_param}.
\begin{table}
	\begin{center}
		\begin{tabular}{c|l|c|c|c|}
			\cline{2-5}
			& Video Clips & Resolution & \# Frame & \# Tube\\
			\hline
			\multicolumn{1}{|c|}{1} & Crossroad III & $1280 \times 720$ & 106,558 & \\
			\hline
			\multicolumn{1}{|c|}{2} & Library lobby II & $1280 \times 720$ & 108,091 & \\
			\hline
			\multicolumn{1}{|c|}{3} & Subway station plaza II & $1280 \times 720$ & 134,622 & \\
			\hline
			\multicolumn{1}{|c|}{4} & Subway station plaza III & $1280 \times 720$ & 108,016 & \\
			\hline
			\multicolumn{1}{|c|}{5} & Subway station plaza IV & $1280 \times 720$ & 108,012 & \\
			\hline
		\end{tabular}
	\end{center}
...
First experiment is conducted by changing $\lambda$ from 0.001 to 10. Results of the experiment is depicted in
