...
\begin{sidewaysfigure}
	...
	\subfloat[]
	{
		\includegraphics[height=0.2\textheight]{ext-He01.eps}
	}
	\subfloat[]
	{
		\includegraphics[height=0.2\textheight]{ext-He02.eps}
	}
	\subfloat[]
	{
		\includegraphics[height=0.2\textheight]{ext-He03.eps}
	}
	\subfloat[]
	{
		\includegraphics[height=0.2\textheight]{ext-He04.eps}
	}
...
The foreground segmentation result is generated by subtracting background from the input image and applying a morphological close operation with the $3\times3$ square structuring element and finding connected components. Then, connected components with less than 0.1\% or greater than 25\% of the input image area are removed from the scene. Computation time (CT) of the algorithm is defined as a time consumption for extracting object tubes from the 1 hour long $640\times360$ video. Result of the different foreground segmentation algorithms are summarized in \Cref{tb:bgm}. 
