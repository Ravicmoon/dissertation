...
%For the original work of Zhu~\etal~\cite{JianqingZhu2015}, instead of using the queue, they utilize two level cache condensed spaces (L1 and L2). When L1 cache space is filled with object tubes, the algorithm generates a portion of the synopsis video. On the other hand, L2 space is for gathering object tubes which do not find proper locations in L1 space.
