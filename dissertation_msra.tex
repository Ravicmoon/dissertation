...
\label{sec:exp:occ}
Second experiment is conducted by changing spatial resolution $\mathcal{M}\times\mathcal{N}$ of the occupation matrix. Assume that the aspect ratio (the ratio of the width to the height) of the input video is 16:9. Under this assumption, four candidates of $\mathcal{M}\times\mathcal{N}$ are considered in this experiment: $9\times16$, $18\times32$, $36\times64$, and $72\times128$. Remaining parameters are fixed as $\lambda=100$ and $K=20$ and the algorithm utilizes both binary and probabilistic occupation matrices.
...
\chapter{Result of proposed framework}
\label{sec:app}
This appendix summarizes some frames of the condensed videos generated by the proposed framework when the original videos are the test sequences described in \Cref{sec:test_video_sequence}. Time stamps in the condensed video indicate objects' appearing time in the original video.

\begin{sidewaysfigure}
	\centering
	\subfloat[]
	{
		\includegraphics[width=0.45\linewidth]{fig/VC1_01.png}
	}
	\qquad
	\subfloat[]
	{
		\includegraphics[width=0.45\linewidth]{fig/VC1_02.png}
	}
	\\
	\subfloat[]
	{
		\includegraphics[width=0.45\linewidth]{fig/VC1_03.png}
	}
	\qquad
	\subfloat[]
	{
		\includegraphics[width=0.45\linewidth]{fig/VC1_04.png}
	}
	\caption{Some frames of the condensed video of Parking lot square I sequence (VC1).}
	\label{fig:result_VC1}
\end{sidewaysfigure}
...
\begin{sidewaysfigure}
	...
	\subfloat[]
	{
		\includegraphics[width=0.45\linewidth]{fig/VC2_01.png}
	}
	\qquad
	\subfloat[]
	{
		\includegraphics[width=0.45\linewidth]{fig/VC2_02.png}
	}
	\\
	\subfloat[]
	{
		\includegraphics[width=0.45\linewidth]{fig/VC2_03.png}
	}
	\qquad
	\subfloat[]
	{
		\includegraphics[width=0.45\linewidth]{fig/VC2_04.png}
	}
	\caption{Some frames of the condensed video of Parking lot square II sequence (VC2).}
	\label{fig:result_VC2}
\end{sidewaysfigure}
...
\begin{sidewaysfigure}
	...
	\subfloat[]
	{
		\includegraphics[width=0.45\linewidth]{fig/VC3_01.png}
	}
	\qquad
	\subfloat[]
	{
		\includegraphics[width=0.45\linewidth]{fig/VC3_02.png}
	}
	\\
	\subfloat[]
	{
		\includegraphics[width=0.45\linewidth]{fig/VC3_03.png}
	}
	\qquad
	\subfloat[]
	{
		\includegraphics[width=0.45\linewidth]{fig/VC3_04.png}
	}
	\caption{Some frames of the condensed video of Crossroad I sequence (VC3).}
	\label{fig:result_VC3}
\end{sidewaysfigure}
...
\begin{sidewaysfigure}
	...
	\subfloat[]
	{
		\includegraphics[width=0.45\linewidth]{fig/VC4_01.png}
	}
	\qquad
	\subfloat[]
	{
		\includegraphics[width=0.45\linewidth]{fig/VC4_02.png}
	}
	\\
	\subfloat[]
	{
		\includegraphics[width=0.45\linewidth]{fig/VC4_03.png}
	}
	\qquad
	\subfloat[]
	{
		\includegraphics[width=0.45\linewidth]{fig/VC4_04.png}
	}
	\caption{Some frames of the condensed video of Crossroad II sequence (VC4).}
	\label{fig:result_VC4}
\end{sidewaysfigure}
...
\begin{sidewaysfigure}
	...
	\subfloat[]
	{
		\includegraphics[width=0.45\linewidth]{fig/VC5_01.png}
	}
	\qquad
	\subfloat[]
	{
		\includegraphics[width=0.45\linewidth]{fig/VC5_02.png}
	}
	\\
	\subfloat[]
	{
		\includegraphics[width=0.45\linewidth]{fig/VC5_03.png}
	}
	\qquad
	\subfloat[]
	{
		\includegraphics[width=0.45\linewidth]{fig/VC5_04.png}
	}
	\caption{Some frames of the condensed video of Library lobby I sequence (VC5).}
	\label{fig:result_VC5}
\end{sidewaysfigure}
...
\begin{sidewaysfigure}
	...
	\subfloat[]
	{
		\includegraphics[width=0.45\linewidth]{fig/VC6_01.png}
	}
	\qquad
	\subfloat[]
	{
		\includegraphics[width=0.45\linewidth]{fig/VC6_02.png}
	}
	\\
	\subfloat[]
	{
		\includegraphics[width=0.45\linewidth]{fig/VC6_03.png}
	}
	\qquad
	\subfloat[]
	{
		\includegraphics[width=0.45\linewidth]{fig/VC6_04.png}
	}
	\caption{Some frames of the condensed video of Subway station plaza I sequence (VC6).}
	\label{fig:result_VC6}
\end{sidewaysfigure}

\end{appendices}

\chapter*{국문 요지}
\addcontentsline{toc}{chapter}{\textbf{국문 요지}}
...
\chapter*{감사의 글}
\addcontentsline{toc}{chapter}{\textbf{감사의 글}}
...
\includepdf[pages={2,3}]{signatures.pdf}
